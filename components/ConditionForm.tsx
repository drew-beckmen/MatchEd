...
export default function ConditionForm({
    ...
    const [numStudents, setNumStudents] = useState(condition ? condition.num_students : 0);
    const [numSchools, setNumSchools] = useState(condition ? condition.num_schools : 0);
    ...
    function buildCondition(e: React.FormEvent<HTMLFormElement>) {
        ...
        fetch(`/api/experiments/${experiment_id}/conditions/${isNew ? "" : condition_id}`, {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-10 divide-y divide-gray-900/10">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3 mb-4">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  Not ready to {isNew ? "create " : "edit "} an experimental condition?{" "}
                  <Link
                    href="/experiments/[id]"
                                    ...
                                    <div className="sm:col-span-2">
                                      ...
                                      <div className="mt-2">
                                        <input
                                          ...
                                          min={1}
                                          max={numSchools}
                                          defaultValue={condition?.students[i].truthful_preferences[j].rank}
                                    ...
                                    <div className="sm:col-span-2">
                                      ...
                                      <div className="mt-2">
                                        <input
                                          ...
                                          defaultValue={condition?.students[i].truthful_preferences[j].payoff}
                                          id="payoff"
                                          min={0}
                                          className="block w-full rounded-md border-0 py-1.5 mb-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                        />
            ...
            <div className="mt-4 grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
              ...
              <form className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" onSubmit={buildCondition}>
                <div className="px-4 py-6 sm:p-8">
                  {numStudents > 0 && numSchools > 0 ? (
                    Array.from({ length: numSchools }, (_, i) => i).map(
                      (school, i) => {
