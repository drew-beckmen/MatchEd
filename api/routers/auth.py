...
@router.post("/login", response_model=Token, description="Login to get an access token.")
...
@router.post("/signup", response_model=Token, description="Sign up and get an access token.")
async def signup_for_access_token(form_data: ResearcherSignUp, db: motor_asyncio.AsyncIOMotorDatabase = Depends(get_db)) -> Token:
