import { saveParticipantData } from "@/app/actions"
...
export default function Page({ params }: { params: { condition_id: string, id: string } }) {
  console.log(params)
  return (
    <>
      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-8">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Welcome to MatchEd! Thank you for participating in this experiment.</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">
            This demographic information collected below may be used to help us understand the impact of the game on different groups of people. We will not share your personally identifying information with anyone.
          </p>
        </div>
        ...
        <div className="border-b border-gray-900/10 pb-8">
          ...
          <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="venmo" className="block text-sm font-medium leading-6 text-gray-900">
                Venmo Username
              </label>
              <div className="mt-2">
                <input
      ...
      <input type="hidden" name="condition_id" value={params.condition_id} />
