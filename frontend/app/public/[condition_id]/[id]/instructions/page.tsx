      ...
      <div className="border-b border-gray-200 rounded-lg bg-white px-4 py-5 sm:px-6 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 my-12">
        ...
        <div className="bg-white shadow-2xl sm:rounded-lg my-12">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-5  flex items-center justify-end">
              <Link
                href={steps == stepsNoRepeat ? `/public/${params.condition_id}/${params.id}/game` : `/public/${params.condition_id}/${params.id}/practice`}
                type="button"
        ...
        <p className="mt-1 text-sm leading-6 text-gray-600">
          ...
          <Link href={`/public/${params.condition_id}/${params.id}`} className="text-indigo-600 hover:text-indigo-900">
            the demographic information page</Link> to complete this step.
        </p>
        </>}
      </div>
    </>
